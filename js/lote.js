$(document).ready(function(){
            ...
            lotes.forEach(lote => {
                templete+=`
                        ...
                        if(lote.estado=='ligth'){
                            tempelte+=`<div class="card bg-light">`;
                        }
                        if(lote.estado=='warning'){
                            tempelte+=`<div class="card bg-warning">`;
                        }
                        if(lote.estado=='danger'){
                            tempelte+=`<div class="card bg-danger">`;
                        }
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="col-7">
                                ...
                                <ul class="ml-4 mb-0 fa-ul">
                                    ...
                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-mortar-calendar-times"></i></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Fecha de Vencimiento: ${lote.vencimiento}</font></font></li>
    ...
    $('#from-editar-lote').submit(e=>{
        let id=$('#id_editar_lote').val();
        let stock=$('#stock').val();
        funcion="editar";
        $.post('../controlador/controlador-lote.php',{funcion,id,stock},(response)=>{
            if (response=='editado') {
                $('#edit-lote').hide('slow');
                $('#edit-lote').show(1000);
