    ...
    function buscar_producto(consulta){
        ...
        $.post('../controlador/controlador-producto.php',{consulta,funcion},(response)=>{
            ...
            productos.forEach(producto => {
                templete+=`
                        <div prodID="${producto.Id_producto}" prodNom="${producto.nombre}" prodPrecio="${producto.precio}"  prodConcentracion="${producto.concentracion}" prodAdicional="${producto.adicional}" prodAvatar="${producto.avatar}" prodTipo="${producto.Id_tipo}" prodPresentacion="${producto.Id_presentacion}" prodLaboratorio="${producto.Id_laboratorio}" prodStock="${producto.stock}" class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                        ...
                        <div class="card-footer">
                            <div class="text-right">
                                <button class="agg-carrtio btn btn-sm btn-primary">
